    ...
    <div className={`flex flex-col items-center justify-center ${className}`}>
      <div className={`relative ${showGlow ? 'animate-glow-pulse' : ''}`}>
        <img 
          ...
          style={{
            filter: showGlow 
              ? 'brightness(1.3) contrast(1.2) saturate(1.5) drop-shadow(0 0 40px rgba(251, 146, 60, 0.4)) drop-shadow(0 0 80px rgba(249, 115, 22, 0.4)) drop-shadow(0 0 20px rgba(245, 158, 11, 0.5))' 
      ...
      {showUnderline && (
        <div 
          ...
          style={{
            background: 'linear-gradient(to right, transparent, rgba(251, 146, 60, 0.6), rgba(249, 115, 22, 0.5), transparent)',
            boxShadow: '0 0 10px rgba(251, 146, 60, 0.4), 0 0 20px rgba(249, 115, 22, 0.3)'
          }}
